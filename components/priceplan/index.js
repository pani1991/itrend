...
const Priceplan = ({ id, class_name, padding }) => {
  ...
  return (
    <div
      className={"priceplan position-relative py-5 " + class_name}
      id={id ? id : ""}
            ...
            <div className="row" style={{ alignItems: "flex-end" }}>
              <div className="col-lg-5 px-0">
                <div>
                  <h2>Subscriptions</h2>
                  <p className="">
                    Access dashboards and premium indicators to uncover Alpha in
                    real-time.
                  </p>
                </div>
              </div>
              <div className="col-lg-7 d-none d-lg-inline px-1 px-lg-2">
            ...
            <div className="row border-top2">
              <div className="col-lg-5 d-flex align-items-center planrow px-0">
                <a
                  ...
                  onClick={() => toggleTab(1)}
                >
                  <span className="mx-1">Monthly</span>
                </a>
                <a
                  className={`tabs btn-light btn ${getActiveClass(
                    2,
                  ...
                  onClick={() => toggleTab(2)}
                >
                  <span className="mx-1">Quarterly</span>
                </a>
                <a
                  className={`tabs btn-light btn ${getActiveClass(
                    3,
