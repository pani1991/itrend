...
const Index = () => {
  const herosection = {
    bigimg: "/bg2222.png",
    head: "AR-VR",
    dec: "Artificial Intelligence and Machine Learning",
    new: null,
    buttomlink: null,
    buttomtitle: null,
    videotitle: null,
  ...
  const content = {
    ...
    front_img:
      "/Portrait-of-a-man-wearing-virtual-reality-glasses-against-dark-backgorund-playing-a-game.jpg",
    title: "Intelligent Operations, Faster Development",
    svg_icone: "/80-804923_profile-icon-png.png",
    desc: "Our AI and Machine Learning services help industries and organizations work smarter and make better business decisions by identifying patterns and using practical data-driven algorithms.<br/><br/>Our ML model helps you quickly process large volumes of data, connect data points, and understand business issues before concluding.",
  };
