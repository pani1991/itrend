...
const Index = () => {
  ...
  const herosection = {
    ...
    head: "Students Welfare Management",
    dec: "High-Level Campus Management with Effective Solutions Designed just for You",
    newbold: "",
    new: null,
    ...
    <div className={"position-relative " + SiteData.direction}>
      ...
      <div className="col-lg-7 col-11 py-5 my-5 col-md-11 mx-auto">
        ...
        <p className="text-justify">
          The learning and training software for The learning and training
          software for The learning and training software for The learning and
          training software for The learning and training software for The
          learning and training software for The learning and training software
          for
        </p>
      </div>
      <Footer
